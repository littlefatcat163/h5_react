...
export default class Format extends BaseComponent {
      ...
      [
        {
          name: 'React组件规范',
          list: [
            { 'data-target': 'reactComponentFormat', name: '组件规范' },
            { 'data-target': 'reactComponentCycle', name: '生命周期' },
            { 'data-target': 'reactComponentDemo', name: '实例' },
            { 'data-target': 'reactComponentRef', name: 'ref' },
            { 'data-target': 'reactComponentAPI', name: 'api' },
            { 'data-target': 'reactComponentEvent', name: '事件' },
            { 'data-target': 'reactComponentHelp', name: '附属文档' }
          ]
        },
        {
          name: 'Sass规范',
          list: [
            { 'data-target': 'sassFormat', name: '编写规范' },
            { 'data-target': 'sassNote', name: '注释' },
            { 'data-target': 'sassDataType', name: '数据类型' },
            { 'data-target': 'sassNumOper', name: '数字运算' },
            { 'data-target': 'sassColorOper', name: '颜色运算' },
            { 'data-target': 'sassInterpolation', name: 'Interpolation' },
            { 'data-target': 'sassDefault', name: '变量默认值' },
            { 'data-target': 'sassImport', name: '@import' },
            { 'data-target': 'sassMedia', name: '@media' },
            { 'data-target': 'sassExtend', name: '@extend' },
            { 'data-target': 'sassIf', name: '@if' },
            { 'data-target': 'sassFor', name: '@for' },
            { 'data-target': 'sassEach', name: '@each' },
            { 'data-target': 'sassWhile', name: '@while' },
            { 'data-target': 'sassMixin', name: '@mixin' },
            { 'data-target': 'sassHelp', name: '附属文档' }
          ]
        },
        {
          name: 'ES6规范',
          list: [
            { 'data-target': 'es6Scope', name: '块级作用域' },
            { 'data-target': 'es6Str', name: '字符串' },
            { 'data-target': 'es6Agm', name: '解构赋值' },
            { 'data-target': 'es6Obj', name: '对象' },
            { 'data-target': 'es6Array', name: '数组' },
            { 'data-target': 'es6Func', name: '函数' },
            { 'data-target': 'es6Map', name: 'Map' },
            { 'data-target': 'es6Class', name: 'Class' },
            { 'data-target': 'es6Module', name: '模块' },
            { 'data-target': 'es6Help', name: '附属文档'}
          ]
        }
      ]
    )
  ...
  getRightDOMList() {
    return [
      {
        'data-toggle': 'reactComponentFormat',
        render: () => {
          return (
      ...
      {
        'data-toggle': 'reactComponentCycle',
        render: () => {
          return (
            <div className='xo-padding-xs'>
              <h1>React组件生命周期</h1>
      ...
      {
        'data-toggle': 'reactComponentDemo',
        render: () => {
          return (
            <div className='xo-padding-xs'>
              <h1>实例</h1>
      ...
      {
        'data-toggle': 'reactComponentEvent',
        render: () => {
          return (
            <div className='xo-padding-xs'>
              <h1>事件</h1>
      ...
      {
        'data-toggle': 'reactComponentHelp',
        render: () => {
          return (
            <div className='xo-padding-xs'>
              <h1>附属文档</h1>
